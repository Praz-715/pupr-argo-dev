...
- [ ] Syarat **diklat** juga dideklarasikan dari tab yang sama — masih SQL-only, belum ada UI-nya
...
- [x] Berkas smoke `fase-11` (**25 pemeriksaan**); `ukur:kueri` memuat kueri Kotak 9 per target dan lolos ambangnya (**77 kueri · 327 ms**, tiga kueri baru 3 ms masing-masing)
